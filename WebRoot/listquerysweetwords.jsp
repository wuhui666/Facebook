...
a.module:hover{
  ...
  <body>
    ...
    <a href="sweetwordsquery?start=0&account=<%=request.getParameter("account")%>&querynumber=<%=request.getParameter("querynumber")%>"><button class="btn btn-default">首页</button></a>
    <a href="sweetwordsquery?start=${pre}&account=<%=request.getParameter("account")%>&querynumber=<%=request.getParameter("querynumber")%>"><button class="btn btn-default">上一页</button></a>
    <a href="sweetwordsquery?start=${next}&account=<%=request.getParameter("account")%>&querynumber=<%=request.getParameter("querynumber")%>"><button class="btn btn-default">下一页</button></a>
    <a href="sweetwordsquery?start=${last}&account=<%=request.getParameter("account")%>&querynumber=<%=request.getParameter("querynumber")%>"><button class="btn btn-default">末页</button></a>
    </td>
    </tr>
   </table>
